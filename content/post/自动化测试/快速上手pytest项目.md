...
克隆项目◦ git clone user@example.com:clinic-diag/test/poct_api_test.git
了解项目结构

![](/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.jpg)
