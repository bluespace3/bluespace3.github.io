...
首先需要在 `src/test/resources/config/registered-apps.json` 中注册已知的应用和对应的login接口：
...
├── src/main/java/com/example/service/      # 测试服务层
...
└── src/test/java/com/example/apitest/      # 测试用例层
