...
- 解决方案：在 `gateway.controlUi.allowedOrigins` 中添加 `http://127.0.0.1:18789`
...
{
  "env": {
    "ANTHROPIC_AUTH_TOKEN": "0ca0695828e34275a6b7d871c9849bc2.Ss7mK5hNbUjSAZPg",
...
- API Key: `AIzaSyABrUgGuY0GDTMsa7a1aWb_QOVGD14c-qA`
...
- 监控脚本：`/root/.openclaw/workspace/scripts/monitor-idle-processes.sh`
- 1Panel 面板：http://38.55.39.104:17523/65f2738c00
