...
```typescript
#!/usr/bin/env node
import { Server } from '@xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.js';
import { StdioServerTransport } from '@xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.js';
